...
export const API_ENDPOINTS = {
      ...
      USERS: {
        ...
        REQUEST_VENDOR: (walletAddress: string) => `${API_BASE_URL}/users/${walletAddress}/vendor-request`,
      },
  ...
  REWARDS: {
    ...
    GET_BY_EVENT: (eventId: string) => `${API_BASE_URL}/rewards/event/${eventId}`,
      ...
      EVENTS: {
        ...
        GET_PARTICIPANT: (walletAddress: string) => `${API_BASE_URL}/events/participant/${walletAddress}`,
      },
      ...
      SUBSCRIPTIONS: {
        ...
        NEXT_PAYMENTS: `${API_BASE_URL}/subscriptions/next-payments`,
      },
      ...
      PAYMENT_LINKS: {
        ...
        GET_INITIATED: (walletAddress: string) => `${API_BASE_URL}/payment-links/initiated/${walletAddress}`,
      },
